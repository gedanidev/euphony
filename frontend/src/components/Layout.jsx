    ...
    <div className="flex h-screen bg-[#0f0f13] text-[#e2e8f0] overflow-hidden">
      <aside className="w-56 flex-shrink-0 bg-[#1a1a24] border-r border-[#2e2e4a] flex flex-col">
        ...
        <nav className="flex-1 p-3 space-y-1">
          ...
          <NavItem to="/library" label="Biblioteca" icon={
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" />
            </svg>
          } />
          <NavItem to="/artists" label="Artistas" icon={
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          <NavItem to="/import" label="Importar" icon={
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" />
            </svg>
          } />
          <NavItem to="/settings" label="Ajustes" icon={
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
